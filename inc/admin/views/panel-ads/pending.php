    ...
    <?php foreach ( $ads as $sold ){ ; ?>
        ...
        <li>
            <span class="s1">
                ...
                <button class="mn-btn mn-btn-approve" data-id="<?php echo $sold->id; ?>" >
                    <span class="dashicons dashicons-thumbs-up"></span>
                    <span class="mn-btn-title"><?php _e('Approve','ddabout'); ?></span>
                </button>
                ...
                <button class="mn-btn mn-btn-delete-pending" data-id="<?php echo $sold->id; ?>">
...
<div class="mn-panel-pagination">
    ...
    MoneyHelper::pagination(
        $pendingTotal,
        5,
        admin_url('admin.php?page=money-ads&mn-panel-page=pending&mn-paged='),
        $paged
    );
    ?>
</div>