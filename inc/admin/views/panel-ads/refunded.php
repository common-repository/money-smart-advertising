    ...
    <?php foreach ( $ads as $sold ){ ; ?>
        ...
        <li>
            ...
            <span class="s3">
                ...
                <br>
                <strong><?php _e('Refunded','ddabout'); ?></strong> : <?php echo $sold->refund_amount; ?> <?php echo $sold->currency; ?>
            </span>
            ...
            <span class="s5">
                ...
                <strong><?php _e('Refund date','ddabout'); ?></strong> : <?php echo $sold->date_end; ?><br>
...
<div class="mn-panel-pagination">
    ...
    MoneyHelper::pagination(
        $refundedTotal,
        5,
        admin_url('admin.php?page=money-ads&mn-panel-page=refunded&mn-paged='),
        $paged
    );
    ?>
</div>