    ...
    <?php foreach ( $ads as $sold ){ ; ?>
        ...
        <li>
            <span class="s1">
                ...
                <a class="mn-btn mn-btn-checkout" href="#" data-demo_id="<?php echo $sold->ad_demo_id; ?>" >
                    <span class="dashicons dashicons-cart"></span>
                    <span class="mn-btn-title"><?php _e('Renewal','ddabout'); ?></span>
                </a>
            ...
            <span class="s5">
                ...
                <strong><?php _e('Expire date','ddabout'); ?></strong> : <?php echo $sold->date_end; ?><br><br>
...
<div class="mn-panel-pagination">
    ...
    MoneyHelper::pagination(
        $expiredTotal,
        5,
        admin_url('admin.php?page=money-user-ads&mn-panel-page=expired&mn-paged='),
        $paged
    );
    ?>
</div>